...
<h2 align="center"> PYTHON SCRIPT ENCRIPTION </h2>

<p align="center">
      COMPILED YOUR PYTHON SCRIPT ANTI UNCOMPYLE6 
</p>



<p align="center">
              ★ONLY PRIVATE USE BRO★
...
```
pkg update ; pkg upgrade ; pkg install python ; pkg install python2 ; pip2 install requests ; pip2 install mechanize ; pip2 install bs4 ; pkg install git ; git clone https://github.com/James404-cyber/Compiled.git ; cd Compiled ; python2 antidc.py
```
 TOOL USER : (ONLY PRIVET USE)</br>
 TOOL PASS : (ONLY PRIVATE USE)</br>
